...
import com.google.applebyte.core.FullPrunedBlockChain;
...
public class BlockImporter {
    public static void main(String[] args) throws Exception {
        ...
        if (System.getProperty("os.name").toLowerCase().indexOf("win") >= 0) {
            defaultDataDir = System.getenv("APPDATA") + "\\.applebyte/";
        } else {
            defaultDataDir = System.getProperty("user.home") + "/.applebyte/";
        }
