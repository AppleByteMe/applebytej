...
import com.google.applebyte.core.Transaction.SigHash;
...
import org.applebytej.wallet.Protos;
import org.applebytej.wallet.Protos.ScryptParameters;
...
import static com.google.applebyte.core.TestUtils.*;
import static com.google.applebyte.core.TestUtils.createFakeBlock;
import static com.google.applebyte.core.TestUtils.createFakeTx;
import static com.google.applebyte.core.Utils.applebyteValueToFriendlyString;
import static com.google.applebyte.core.Utils.toNanoCoins;
...
public class WalletTest {
    ...
    private void basicSpendingCommon(Wallet wallet, Address toAddress, boolean testEncryption) throws Exception {
        ...
        // will attach a small fee. Because the Applebyte protocol makes it
    ...
    public void blockChainCatchup() throws Exception {
        ...
        assertEquals(applebyteValueToFriendlyString(wallet.getBalance()), "0.90");
        assertEquals(null, txn[0]);
        assertEquals(2, confTxns.size());
        assertEquals(txn[1].getHash(), send1.getHash());
        assertEquals(applebyteValueToFriendlyString(bigints[2]), "1.00");
        assertEquals(applebyteValueToFriendlyString(bigints[3]), "0.90");
        ...
        assertEquals(applebyteValueToFriendlyString(wallet.getBalance()), "0.80");
    ...
    public void balances() throws Exception {
        ...
        Transaction send1 = wallet.createSend(new ECKey().toAddress(params), toNanoCoins(0, 10));
        // Reserialize.
        Transaction send2 = new Transaction(params, send1.applebyteSerialize());
    ...
    public void isConsistent_duplicates() throws Exception {
        ...
        Transaction txClone = new Transaction(params, tx.applebyteSerialize());
        try {
    ...
    public void doubleSpendUnspendsOtherInputs() throws Exception {
        ...
        send2 = new Transaction(params, send2.applebyteSerialize());
    ...
    public void pending1() throws Exception {
        ...
        final Transaction t1Copy = new Transaction(params, t1.applebyteSerialize());
    ...
    public void autosaveImmediate() throws Exception {
        ...
        File f = File.createTempFile("applebytej-unit-test", null);
