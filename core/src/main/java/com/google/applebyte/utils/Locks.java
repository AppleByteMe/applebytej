...
package com.google.applebyte.utils;
...
/**
 * A wrapper around explicit lock creation that lets you control whether applebytej performs cycle detection or not.
 */
public class Locks {

    static {
        // Default policy goes here. If you want to change this, use one of the static methods before
        // instantiating any applebytej objects. The policy change will take effect only on new objects
