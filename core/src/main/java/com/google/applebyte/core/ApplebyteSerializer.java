...
/**
 * <p>Methods to serialize and de-serialize messages to the Applebyte network format as defined in
 ...
 * <li>Message.applebyteSerializeToStream() needs to be properly subclassed</li>
 * </ul>
 */
public class ApplebyteSerializer {
    private static final Logger log = LoggerFactory.getLogger(ApplebyteSerializer.class);
    ...
    /**
     * Constructs a ApplebyteSerializer with the given behavior.
     *
     * @param params           networkParams used to create Messages instances and termining packetMagic
     */
    public ApplebyteSerializer(NetworkParameters params) {
     ...
     */
    public ApplebyteSerializer(NetworkParameters params, boolean parseLazy, boolean parseRetain) {
        this.params = params;
    ...
    public void serialize(Message message, OutputStream out) throws IOException {
        ...
        if (name == null) {
            throw new Error("ApplebyteSerializer doesn't currently know how to serialize " + message.getClass());
        }
        ...
        byte[] payload = message.applebyteSerialize();
    ...
    public Message deserialize(InputStream in) throws ProtocolException, IOException {
        // A Applebyte protocol message has the following format.
        //
        ...
        ApplebytePacketHeader header = new ApplebytePacketHeader(in);
     ...
     */
    public ApplebytePacketHeader deserializeHeader(InputStream in) throws ProtocolException, IOException {
        return new ApplebytePacketHeader(in);
    }

    /**
     * Deserialize payload only.  You must provide a header, typically obtained by calling
     * {@link ApplebyteSerializer#deserializeHeader}.
     */
    public Message deserializePayload(ApplebytePacketHeader header, InputStream in) throws ProtocolException, IOException {
        int readCursor = 0;
    ...
    public static class ApplebytePacketHeader {
        public final byte[] header;
        public final String command;
        public final int size;
        public final byte[] checksum;

        public ApplebytePacketHeader(InputStream in) throws ProtocolException, IOException {
