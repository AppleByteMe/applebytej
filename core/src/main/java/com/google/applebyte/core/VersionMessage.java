...
public class VersionMessage extends Message {
    ...
    public static final String APPLEBYTEJ_VERSION = "0.8-SNAPSHOT";
    /** The value that is prepended to the subVer field of this application. */
    public static final String LIBRARY_SUBVER = "/ApplebyteJ:" + APPLEBYTEJ_VERSION + "/";
    ...
    @Override
    public void applebyteSerializeToStream(OutputStream buf) throws IOException {
        ...
        try {
            // My address.
            myAddr.applebyteSerialize(buf);
            // Their address.
            theirAddr.applebyteSerialize(buf);
        } catch (UnknownHostException e) {
     ...
     * name:version pairs separated by slashes in the form of a path. For example a typical subVer field for ApplebyteJ
     * users might look like "/ApplebyteJ:0.4-SNAPSHOT/MultiBit:1.2/" where libraries come further to the left.<p>
     *
     ...
     * set of "/ApplebyteJ:1.0/MultiBit:1.0(Windows)/. Therefore the / ( and ) characters are reserved in all these
     * components. If you don't want to add a comment (recommended), pass null.<p>
     *
     * See <a href="https://en.applebyte.it/wiki/BIP_0014">BIP 14</a> for more information.
     *
