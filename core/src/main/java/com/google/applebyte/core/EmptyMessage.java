 ...
 * Currently this includes getaddr, ping, verack as well as the special applebytej class UnknownMessage
 *
 * @author git
 */
public abstract class EmptyMessage extends Message {
    ...
    @Override
    final protected void applebyteSerializeToStream(OutputStream stream) throws IOException {
    }
    ...
    /* (non-Javadoc)
      * @see Message#applebyteSerialize()
      */
    @Override
