...
/**
 * <p>A {@code TCPNetworkConnection} is used for connecting to a Applebyte node over the standard TCP/IP protocol.<p>
 *
...
public class TCPNetworkConnection implements NetworkConnection {
    ...
    private ApplebyteSerializer serializer = null;
    ...
    public TCPNetworkConnection(NetworkParameters params, VersionMessage ver) {
        ...
        this.serializer = new ApplebyteSerializer(this.params);
    ...
    private void onVersionMessage(Message m) throws IOException, ProtocolException {
        ...
        // applebytej is a client mode implementation. That means there's not much point in us talking to other client
    ...
    public class NetworkHandler extends ReplayingDecoder<VoidEnum> implements ChannelDownstreamHandler {
        ...
        // Attempt to decode a Applebyte message passing upstream in the channel.
        //
        ...
        /** Serialize outgoing Applebyte messages passing downstream in the channel. */
    ...
    /** Returns the Netty Pipeline stage handling Applebyte serialization for this connection. */
