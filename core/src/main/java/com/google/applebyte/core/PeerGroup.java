...
import com.google.applebyte.core.Peer.PeerHandler;
...
public class PeerGroup extends AbstractIdleService {
    ...
    // pipeline with the applebyte serializer ({@code TCPNetworkConnection}) downstream
     ...
     * <a href="https://en.applebyte.it/wiki/BIP_0014">BIP 14</a>.
     *
     ...
     * peers. By using this with {@link com.google.applebyte.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link com.google.applebyte.core.PeerGroup#getMaxConnections()} returns is used.
     * @return
     */
    ...
    /**
     * See {@link com.google.applebyte.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * someone and want to know that it's valid. It's a bit of a weird hack because the current version of the Applebyte
     ...
     * times are available via {@link com.google.applebyte.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link com.google.applebyte.core.Peer#ping()}.
     */
